...
- For TamJai SamGor receipts, OCR often misreads `蒟蒻麵` and `蜂巢豆腐`. Preserve the exact printed text, treat them as distinct menu items, and do not normalize or merge them into adjacent dish names unless the receipt clearly indicates otherwise.
