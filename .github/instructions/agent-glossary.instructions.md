...
- Scripts & working directory: Prefer `bun run <script>` from repo root; when invoking Python directly, set `cwd=scripts/`. See `.github/instructions/agent-quickstart.instructions.md` for a concise checklist of the most-used commands and gotchas.
